...
public class MealFormFrame extends JFrame{
    //Header Panel
    ...
    private MealMenu mgr;
    
    // when set, action is edit
    private Main_ItemMenu rrent;
    
    public MealFormFrame(OrderMenuFRAME orderFrame, MealMenu mgr){
        ...
        //LABELS
        lblHead = new JLabel("Pastry Inventory", JLabel.CENTER);
